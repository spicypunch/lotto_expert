...
part 'lotto_number_response.g.dart';
...
class LottoNumberResponse {
  ...
  factory LottoNumberResponse.fromJson(Map<String, dynamic> json) =>
      _$LottoNumberResponseFromJson(json);

  Map<String, dynamic> toJson() => _$LottoNumberResponseToJson(this);
}
